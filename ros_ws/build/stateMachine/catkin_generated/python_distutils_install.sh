...
echo_and_run cd "/home/orca/dvic/THEDRONELAB/ros_ws/src/stateMachine"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/orca/dvic/THEDRONELAB/ros_ws/src/stateMachine/setup.py" \
     \
    build --build-base "/home/orca/dvic/THEDRONELAB/ros_ws/build/stateMachine" \
    install \
    --root="${DESTDIR-/}" \
