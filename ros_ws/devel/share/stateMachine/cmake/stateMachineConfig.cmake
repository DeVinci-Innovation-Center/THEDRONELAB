...
if("TRUE" STREQUAL "TRUE")
  set(stateMachine_SOURCE_PREFIX /home/dronelab/DRONELAB/THEDRONELAB/ros_ws/src/stateMachine)
  set(stateMachine_DEVEL_PREFIX /home/dronelab/DRONELAB/THEDRONELAB/ros_ws/devel)
  ...
  set(stateMachine_INSTALL_PREFIX /home/dronelab/DRONELAB/THEDRONELAB/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stateMachine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dronelab/DRONELAB/THEDRONELAB/ros_ws/src/stateMachine/${idir}'.  ${_report}")
    endif()
